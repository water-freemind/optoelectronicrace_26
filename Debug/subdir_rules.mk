...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"D:/CCS/ccs/tools/compiler/ti-cgt-armllvm_4.0.4.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O0 -I"D:/MSP-SDK/CCS_project/optoelectronicrace_26" -I"D:/MSP-SDK/CCS_project/optoelectronicrace_26/Debug" -I"D:/MSP-SDK/mspm0_sdk_2_10_00_04/source/third_party/CMSIS/Core/Include" -I"D:/MSP-SDK/mspm0_sdk_2_10_00_04/source" -I"D:/MSP-SDK/CCS_project/optoelectronicrace_26/BSP" -I"D:/MSP-SDK/CCS_project/optoelectronicrace_26/Drive/OLED_Drv" -I"D:/MSP-SDK/CCS_project/optoelectronicrace_26/Menu" -I"D:/MSP-SDK/CCS_project/optoelectronicrace_26/Drive/Knob" -gdwarf-3 -Wall -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)"  $(GEN_OPTS__FLAG) -o"$@" "$<"
